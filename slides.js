...
const SLIDES = [
  ...
  // ---------------------------------------------------------------
  {
    ...
    tooltip: "Startseite",
    cards: [
      { target: "audit", n: "01", t: "Audit", d: "UX-/UI-Mängel & technische SEO-Findings – mit Screenshots." },
      { target: "videos", n: "02", t: "Produktvideos", d: "Animierte Produktbilder, die beim Hover lebendig werden." },
      { target: "chance", n: "03", t: "Chancen", d: "UGC-Content, AI-Bilder & Videos, Affiliate-Programm." },
    ],
  },
  ...
  },
  {
    ...
    observation: "Der fixierte Kauf-Button unten auf der Produktseite heißt „Konfigurieren“ – obwohl es sich um ein fertiges Produkt mit festem Preis handelt (z. B. Hair Growth Conditioner • €47,00).",
    why: "„Konfigurieren“ klingt nach einem optionalen Schritt und bremst die Kaufentscheidung. Besser: klare Kauf-CTAs wie „Jetzt kaufen“, „In den Warenkorb“ oder „Sofort bestellen“ – eindeutig, aktiv und conversion-orientiert.",
    severity: "Hoch",
    mediaRatio: "482 / 122",
    media: [
  ...
  {
    section: "chance",
    title: "AI Bilder & Videos",
    tooltip: "AI Bilder & Videos",
    ...
    mediaRatio: "1 / 1",
    media: [
      { type: "video", src: "assets/videos/chance-ai-1.mp4", caption: "Beispiel AI Bilder & Videos", autoplay: true },
    ],
  },
  {
    section: "chance",
    ...
    why: "Performance-basiertes Wachstum: Partner und Creator bewerben die Marke und werden nur bei echtem Umsatz vergütet – planbares, risikoarmes Skalieren.",
    mediaRatio: "1024 / 686",
    media: [
  ...
  // ---------------------------------------------------------------
  {
    ...
    caseStudy: {
      title: "sim.do",
      observation: "2.242 erfolgreiche Zahlungen in unter 3 Monaten (01.12.2025 – 27.02.2026) – ohne Marketing-Budget, ohne Werbung und ohne Social Media.",
      ...
      media: [
        { type: "image", src: "assets/screenshots/casestudy-simdo-1.png", caption: "sim.do – 2.242 Zahlungen, 0 € Marketing (01.12.2025 – 27.02.2026)" },
      ],
    },
    features: [
      {
